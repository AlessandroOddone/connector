...
class MultipartTest {
  @JsName("Multipart_form_String_Part")
  ...
  @JsName("Multipart_form_String_PartIterable")
  ...
  @JsName("Multipart_form_Serializable_Part")
  ...
  @JsName("Multipart_form_Serializable_PartIterable")
  ...
  @JsName("Multipart_form_HttpBody_Part")
  ...
  @JsName("Multipart_form_HttpBody_PartIterable")
  ...
  @JsName("PartMap_Map_with_String_values")
  ...
  @JsName("PartMap_Map_with_Serializable_values")
  ...
  @JsName("PartMap_Map_with_HttpBody_values")
  ...
  @JsName("PartMap_List_of_Pairs_with_String_values")
  ...
  @JsName("PartMap_List_of_Pairs_with_Serializable_values")
  ...
  @JsName("PartMap_List_of_Pairs_with_HttpBody_values")
  ...
  @JsName("Multipart_mixed_String_Part")
  ...
  @JsName("Multipart_mixed_String_PartIterable")
  ...
  @JsName("Multipart_mixed_Serializable_Part")
  ...
  @JsName("Multipart_mixed_Serializable_PartIterable")
  ...
  @JsName("Multipart_mixed_HttpBody_Part")
  ...
  @JsName("Multipart_mixed_HttpBody_PartIterable")
  ...
  @JsName("PartData_BinaryItem_Part")
  ...
  @JsName("Multipart_form_with_multiple_parameters")
  ...
  @JsName("Multipart_mixed_with_multiple_parameters")
  ...
  @JsName("Multipart_null_arguments")
  ...
  @JsName("Multipart_collections_with_null_values")
  ...
  @JsName("Empty_request_body_when_all_parts_are_missing")
  ...
  @JsName("Part_without_a_Content_Type")
  ...
  @JsName("Part_with_an_empty_Content_Type")
  ...
  @JsName("PartIterable_without_a_Content_Type")
  ...
  @JsName("PartIterable_with_an_empty_Content_Type")
  ...
  @JsName("PartMap_without_a_Content_Type")
  ...
  @JsName("PartMap_with_an_empty_Content_Type")
...
internal suspend fun HttpLogEntry.assertHasMultipartContent(
  subtype: String,
  parts: List<TextPart>
) {
  assertTrue(parts.isNotEmpty(), message = "Multipart body parts must not be empty")

  val actualContentType = requestBody.contentType
  assertTrue(
    actualContentType?.contentType == "multipart" && actualContentType.contentSubtype == subtype,
    message = "Multipart request Content-Type must be 'multipart/$subtype'. Found: '$actualContentType'"
  )
  actualContentType!!

  val boundaryParameters = actualContentType.parameters.filter { it.name == "boundary" }
  assertTrue(
    boundaryParameters.singleOrNull()?.value?.isNotBlank() == true,
    message = "Multipart request Content-Type must define exactly one 'boundary' parameter with a non-blank value. " +
      "Found: '$actualContentType'"
  )
  ...
  assertEquals(
    ...
    requestBody.toByteArray().decodeToString()
  )
}
